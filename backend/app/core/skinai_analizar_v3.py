...
from .skinai_config import (
    ...
    BOOST_PIEL_SENSIBLE_ROSACEA, BOOST_PIEL_SENSIBLE_ROSACEA_INFL, BOOST_PIEL_SENSIBLE_PERIORAL,
...
def ajustar_por_perfil(probs_raw: np.ndarray, perfil: dict,
    ...
    if tipo_piel == 'Sensible':
        ...
        _boost('rosacea-inflammatory', BOOST_PIEL_SENSIBLE_ROSACEA_INFL)
        _boost('perioral-dermatitis', BOOST_PIEL_SENSIBLE_PERIORAL)
    if tipo_piel == 'Grasa':
